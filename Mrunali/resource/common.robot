...
*** Variables ***
${username}               mrunali.kavalekar@capgemini.com.uat2
${login_url}              https://waters--sit2.lightning.force.com/          # Salesforce instance. NOTE: Should be overwritten in CRT variables
